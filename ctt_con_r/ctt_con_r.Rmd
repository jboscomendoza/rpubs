...
Para fines prácticos, lo anterior nos dice que mientras construyamos un instrumentos psicométrico de manera apropiada, sus resultados no deberían presentar sesgo estadístico.
...
* Los puntajes de los ítems dependen de la muestra, por lo tanto el puntaje de los instrumentos también lo hará. En consecuencia, los indicadores psicométricos de una instrumento y las personas que lo han contestado son inseparables.
...
# CTT con R
R cuenta con el paquete `CTT` que nos facilita realizar los análisis relacionado con este marco de referencia de manera sencilla.
...
Usaremos un subconjunto de datos de una evaluación nacional de aprendizaje de matemáticas, realizada emn 2018 a estudiantes de sexto de primaria de México.
...
Comprobamos que este resumen corresponde con nuestros datos, 25 reactivo y respuestas de 450 personas. También hemos obtenido un valor de Alpha de Cronbach igual a $0.836$. En la siguiente sección veremos cómo interpretar este y los demás demás resultados obtenidos.
...
Para realizar el análisis de distractores necesitamos los patrones de respuesta originales, antes de condificarse a $0$ y $1$. Usaremos un conjunto de datos y clave de respuesta incluidas con el paquete `CTT`.
