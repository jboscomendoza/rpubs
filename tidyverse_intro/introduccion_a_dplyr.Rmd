...
Para realizar operaciones con el punto, usamos llaves.
...
Lo que ocurre dentro de las llaves, en realidad, sigue las mismas reglas que el código que pertenece a una función. De modo que lo anterior, es equivalente a escribir el bloque siguiente.
